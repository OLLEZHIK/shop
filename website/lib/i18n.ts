...
const en = {
  ...
  search: {
    ...
    geoDenied: "Location is off - pick a district instead.",
    geoFar: (city: string) => `We're not in your area yet - showing ${city}.`,
...
const sk: Dictionary = {
  ...
  search: {
    ...
    geoDenied: "Poloha je vypnutá - vyberte radšej mestskú časť.",
    geoFar: (city: string) => `Vo vašej oblasti zatiaľ nie sme - zobrazujeme ${city}.`,
