// pawenn duo-companion logo (see design/logo-concepts/05). The
// wordmark color is a prop so the same mark works on the dark footer.
export function Logo({
  className = "h-9 w-auto",
  wordmarkColor = "#004E89",
}: {
  className?: string;
  wordmarkColor?: string;
}) {
  return (
    <svg viewBox="0 0 320 80" className={className} role="img" aria-label="pawenn">
