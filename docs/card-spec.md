...
Для Братиславы цены груминга уже лежат в `data/salon-prices-bratislava.csv`
(старый формат: `salon_name` вместо `business_slug`, `size_class` вместо
весовых столбцов, размер и вес — в оригинальной строке в `notes`). Коды
услуг там уже приведены к этому списку (2026-09-25).
